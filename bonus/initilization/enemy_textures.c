...
/*   Updated: 2022/07/04 18:57:36 by fquist           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/cub3D_bonus.h"

static void	init_enemy_textures_3(t_data *game)
{
...
static void	init_enemy_textures_2(t_data *game)
{
	...
	if (game->imgs.enemy[13] == NULL)
		error(game, "\033[0;31mError: Couldn't load enemy textures.\033[m\n");
	init_enemy_textures_3(game);
}

void	init_enemy_textures(t_data *game)
{
